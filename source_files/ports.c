...
void Init_Ports(void){  //inits all ports
//----------------------------------------------------------------------------
  Init_Port1();     //init port 1
  Init_Port2();     //init port 2
  Init_Port3();     //init port 3
  Init_Port4();     //init port 4
  Init_Port5();     //init port 5
  Init_Port6();     //init port 6
//----------------------------------------------------------------------------
}
...
//----------------------------------------------------------------------------
  ...
  P1OUT  &= ~RED_LED;               // INIT LOW
  P1DIR  |=  RED_LED;               //DIR = OUTPUT

  P1SEL0 |=  A1_SEEED;                // A1_SEEED ADC operation
  P1SEL1 |=  A1_SEEED;                // A1_SEEED ADC operation

  P1SEL0 |=  V_DETECT_L;              // V_DETECT_L ADC operation
  P1SEL1 |=  V_DETECT_L;              // V_DETECT_L ADC operation

  P1SEL0 |=  V_DETECT_R;              // V_DETECT_R ADC operation
  P1SEL1 |=  V_DETECT_R;              // V_DETECT_R ADC operation

  P1SEL0 |=  A4_SEEED;                // A4_SEEED ADC operation
  P1SEL1 |=  A4_SEEED;                // A4_SEEED ADC operation

  P1SEL0 |=  V_THUMB;                 // V_THUMB ADC operation
  P1SEL1 |=  V_THUMB;                 // V_THUMB ADC operation
