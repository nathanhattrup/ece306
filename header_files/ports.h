...
// Port 2 Pins
#define SLOW_CLK              (0x01) // 2.0 SLOW_CLK(was LCD Reset)
...
#define DAC_CNTL               (0x20) // 3.5 DAC_CNTL (or DAC_CTRL_3)
#define IOT_LINK_CPU           (0x40) // 3.6 IOT_LINK_GRN
#define IOT_EN_CPU                 (0x80) // 3.7 IOT_EN              1

// Port 4 Pins
#define RESET_LCD             (0x01) // 4.0 RESET_LCD (WAS DAC_CNTL1)
...
#define L_FORWARD              (0x04) // 6.2 P6_1_PWM (WAS R_REV)
#define R_REVERSE              (0x08) // 6.3 P6_2_PWM (WAS L_FWD)
